...
export const About = () => {
  return (
    <section id="about" className="scroll-mt-24">
      <div className="min-h-screen bg-background text-foreground overflow-x-hidden relative pt-24 px-4">
        <div className="container mx-auto max-w-6xl">
          {/* Section Title */}   
          <h2 className="text-3xl font-bold mb-6 text-glow text-center">About Me</h2>
